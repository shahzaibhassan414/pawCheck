...
/// first mounts, then stops. Deliberately one-shot (no repeat/reverse) —
/// see the identical widget in `features/onboarding/widgets` for the full
/// rationale (kept feature-local rather than shared, in line with this
/// project's feature-first folder structure).
